import { getTokenAction, onLoginAction } from "@/app/[locale]/actions";

import { HttpServiceAbstract, IParams, TMethod } from "@/types/services";
...
> extends HttpServiceAbstract<T> {
  ...
  protected async put(
    ...
    const isFormData = body instanceof FormData;
    const data = isFormData ? body : JSON.stringify(body);
